...
declare global {
  ...
  const ThemeProvider: typeof import('/Users/ag/Development/BrowserOS/packages/browseros-agent/apps/agent/components/theme-provider').ThemeProvider
  ...
  const useIsMobile: typeof import('/Users/ag/Development/BrowserOS/packages/browseros-agent/apps/agent/hooks/use-mobile').useIsMobile
  const useMemo: typeof import('react').useMemo
  const useReducer: typeof import('react').useReducer
  const useRef: typeof import('react').useRef
  const useState: typeof import('react').useState
  const useTheme: typeof import('/Users/ag/Development/BrowserOS/packages/browseros-agent/apps/agent/components/theme-provider').useTheme
}
// for type re-export
declare global {
  // @ts-ignore
  ...
  // @ts-ignore
  export type { ThemeProviderProps } from '/Users/ag/Development/BrowserOS/packages/browseros-agent/apps/agent/components/theme-provider'
  import('/Users/ag/Development/BrowserOS/packages/browseros-agent/apps/agent/components/theme-provider')
}
