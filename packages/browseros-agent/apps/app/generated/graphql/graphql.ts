...
export type BulkCreateConversationMessagesInput = {
  ...
  pMessages?:
    | Array<ConversationMessageInputRecordInput | null | undefined>
    | null
    | undefined
}
...
export type GetProfileIdByUserIdQuery = {
  profileByUserId: { rowId: string } | null
}
...
export type GetUploadedMessageCountQuery = {
  conversationMessages: { totalCount: number } | null
}
...
export type CreateLlmProviderForUploadMutation = {
  createLlmProvider: { llmProvider: { rowId: string } | null } | null
}
...
export type UpdateLlmProviderForUploadMutation = {
  updateLlmProvider: { llmProvider: { rowId: string } | null } | null
}
...
export type CreateScheduledJobMutation = {
  createScheduledJob: { scheduledJob: { rowId: string } | null } | null
}
...
export type UpdateScheduledJobMutation = {
  updateScheduledJob: { scheduledJob: { rowId: string } | null } | null
}
...
export type DeleteScheduledJobMutation = {
  deleteScheduledJob: { deletedScheduledJobId: string | null } | null
}
...
export type CreateConversationWithMessageMutation = {
  createConversation: { conversation: { rowId: string } | null } | null
  createConversationMessage: {
    conversationMessage: { rowId: string; orderIndex: number } | null
  } | null
}
...
export type UpdateConversationLastMessagedAtMutation = {
  updateConversation: {
    conversation: { rowId: string; lastMessagedAt: string } | null
  } | null
}
...
export type GetConversationWithMessagesQuery = {
  conversation: {
    rowId: string
    conversationMessages: { nodes: Array<{ message: any } | null> }
  } | null
}
...
export type DeleteRemoteLlmProviderMutation = {
  deleteLlmProvider: { deletedLlmProviderId: string | null } | null
}
...
export type DeleteConversationMutation = {
  deleteConversation: { deletedConversationId: string | null } | null
}
